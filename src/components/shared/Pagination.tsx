...
export default function Pagination({
  ...
  return (
    <nav
      ...
      className="mt-10 flex items-center justify-between gap-4 rounded-2xl border border-slate-800/80 bg-slate-950/80 px-3 py-3 text-sm text-slate-200"
    >
...
function PaginationButton({
  ...
  const styles =
    "inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-medium transition disabled:opacity-40 disabled:cursor-not-allowed";
